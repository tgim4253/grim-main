...
const SidebarPanel: React.FC<SidebarProps> = ({ sidebarPosition }) => {
  ...
  return (
    <div className="w-full border-border-sidebar border-t border-r rounded-tr-sm rounded-tl-md bg-sidebar text-text overflow-y-auto h-full overflow-x-hidden">
